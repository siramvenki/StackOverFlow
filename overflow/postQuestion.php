...
<?php
      ...
      else
      {
        include "header.php";
         ...
         if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $result=$mysqli->query("INSERT INTO questions(userName,question,code) VALUES('$user','$question','$code')");
         ...
         <div class="row container">
          ...
          <div class="card blue-grey darken-1">
            <div class="card-content  white-text">
              ...
              <span class="card-title ">How to post a Technical Question</span>
              <p>
                "Technical Question Post" enables user to submit question  which includes the question and the required code snippet.
              </p>
              <br>
            </div>
  ...
  <div class="container">
    ...
    <form class="col l9" method="POST" action="postQuestion.php">
